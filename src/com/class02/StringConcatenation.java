...
public class StringConcatenation {
	...
	public static void main(String[] args) {
	    ...
	    //anyting a touch the String , we need to plus sign(+).
		//for space we have two way:
		//first-->  String name=" Anna"
		//second-->System.out.println("Good morning "+name);
		...
		int num1=12;
		int num2=13;
		//The vale of num1=_ and the value of num2=_
