...
public class AllMaps {
	...
	public static void main(String[] args) {
		...
		Map<Integer,String> hashMap=new HashMap<>();//HashMap<>() her hangi bir sirama yoktur.1 null key ve cok fazla
		// null value olabilir.
		...
		Map<Integer,String> linkedHashMap=new LinkedHashMap<>();//LinkedHashMap<> yazdigimiz siralamayi takip eder
		//1 null key ve cok fazla null value olabilir.
		...
		Map<Integer,String> treeMap=new TreeMap<>();//new TreeMap<>(); alfabetik siramayi takip eder.
		//NOT null key olmaz fakat cok fazla null value oabilir.
		...
		Map<String,String> hashTable=new Hashtable<>();//Hashtable<>(); hashmap e cok benzer bu da herhangi bir sirama
		//takip etmez.    //NOTTTTTTTTT:   null key ve null value olmaz
